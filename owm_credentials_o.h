...
String apikey       = "xxxxxxxxxxxxxxxxxxxxxxxxx";                      // See: https://openweathermap.org/
...
String City             = "Hong Kong";                          // Your home city See: http://bulk.openweathermap.org/sample/
...
String Latitude         = "22.312";                         // Latitude of your location in decimal degrees
String Longitude        = "114.257";                         // Longitude of your location in decimal degrees
...
const char* Timezone    = "EET-2EEST,M3.5.5/0,M10.5.5/0";  // Choose your time zone from: https://github.com/nayarsystems/posix_tz_db/blob/master/zones.csv 
